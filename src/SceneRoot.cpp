...
void SceneRoot::CreateSolarSystem()
{
	...
	graphNodes[8]->AddChild(NewObject(glm::vec3(0, 0, 5), glm::vec3(20.0f, 0.0f, -10.0f), glm::vec3(1.0f), "none"));								// [09] Planeta2_Grupa
	...
	graphNodes[11]->AddChild(NewObject(glm::vec3(2, 0, 0), glm::vec3(0.0f), glm::vec3(0.4f), "none"));								// [12] Planeta2_KsiÍøyc1

	graphNodes[3]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [13] Planeta3_åcierzka
	graphNodes[13]->AddChild(NewObject(glm::vec3(10, 0, 10), glm::vec3(-20.0f, 0.0f, 0.0f), glm::vec3(1.0f), "none"));				// [14] Planeta3_Grupa
	...
	graphNodes[16]->AddChild(NewObject(glm::vec3(2, 0, 0), glm::vec3(0.0f), glm::vec3(0.4f), "none"));								// [17] Planeta3_KsiÍøyc1
	graphNodes[14]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [18] Planeta3_Orbita2
	graphNodes[18]->AddChild(NewObject(glm::vec3(3, 0, 0), glm::vec3(0.0f), glm::vec3(0.5f), "none"));								// [19] Planeta3_KsiÍøyc2
	graphNodes[14]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [20] Planeta3_Orbita3
	graphNodes[20]->AddChild(NewObject(glm::vec3(5, 0, 0), glm::vec3(0.0f), glm::vec3(0.3f), "none"));								// [21] Planeta3_KsiÍøyc3

	graphNodes[4]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [22] Planeta4_åcierzka
	graphNodes[22]->AddChild(NewObject(glm::vec3(20, 0, 30), glm::vec3(10.0f, 0.0f, 20.0f), glm::vec3(1.0f), "none"));				// [23] Planeta4_Grupa
	...
	graphNodes[25]->AddChild(NewObject(glm::vec3(2, 0, 0), glm::vec3(0.0f), glm::vec3(0.4f), "none"));								// [26] Planeta4_KsiÍøyc1
	graphNodes[23]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [27] Planeta4_Orbita2
	graphNodes[27]->AddChild(NewObject(glm::vec3(3, 0, 0), glm::vec3(0.0f), glm::vec3(0.5f), "none"));								// [28] Planeta4_KsiÍøyc2
	graphNodes[23]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [29] Planeta4_Orbita3
	graphNodes[29]->AddChild(NewObject(glm::vec3(5, 0, 0), glm::vec3(0.0f), glm::vec3(0.3f), "none"));								// [30] Planeta4_KsiÍøyc3
