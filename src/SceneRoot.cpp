...
void SceneRoot::CreateSolarSystem()
{
	...
	AddChild(NewObject(glm::vec3(-5.0f, 1.0f, -15.0f), glm::vec3(0.0f), glm::vec3(1.0f), "res/models/kostkaReady/kostka.obj"));				// [01] krπøπce punktowe úwiat≥o
	...
	AddChild(NewObject(glm::vec3(0.0f, 15.0f, 0.0f), glm::vec3(0.0f), glm::vec3(3.0f), "res/models/Refrektor/kostka.obj"));					// [03] úwiat≥o kierunkowe
	AddChild(NewObject(glm::vec3(5.0f, 1.0f, 0.0f), glm::vec3(0.0f), glm::vec3(1.0f), "res/models/Refrektor/kostka.obj"));					// [04] úwiat≥o refretorowe 1
	AddChild(NewObject(glm::vec3(-5.0f, 1.0f, 0.0f), glm::vec3(0.0f), glm::vec3(1.0f), "res/models/Refrektor/kostka.obj"));					// [05] úwiat≥o refretorowe 2
