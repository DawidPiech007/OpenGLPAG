...
void SceneRoot::CreateSolarSystem()
{
	...
	//AddChild(NewObject(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(1.0f), "none"));																// [01] oú obrotu úwiat≥a punktowego
	//graphNodes[1]->AddChild(NewObject(glm::vec3(-5.0f, 5.0f, -15.0f), glm::vec3(0.0f), glm::vec3(1.0f), "res/models/kostkaReady/kostka.obj"));	// [02] krπøπce punktowe úwiat≥o
