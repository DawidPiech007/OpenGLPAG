...
void SceneRoot::CreateSolarSystem()
{
	...
	graphNodes[5]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [07] Planeta1_åcierzka
	...
	graphNodes[8]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [10] Planeta2_åcierzka
	...
	graphNodes[13]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [15] Planeta3_åcierzka
	...
	graphNodes[22]->AddChild(NewObject(glm::vec3(0, 0, 0), glm::vec3(0.0f), glm::vec3(1.0f), "none"));								// [24] Planeta4_åcierzka
...
void SceneRoot::UpdateSolarSystem(float time)
{
	...
	graphNodes[1]->SetRotation(0, time * 100, 0);		// Orbita1
